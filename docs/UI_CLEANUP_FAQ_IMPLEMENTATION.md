...
```tsx
<DisclaimerBanner
  message="Estimaciones aproximadas"
  learnMoreUrl="/help/precision"
/>
```
...
<div className="flex justify-between">
  <div>
    <a href="/help">Ayuda</a> •
    <a href="/help/fuentes">Fuentes de Datos</a> •
...
<Card>
  ...
  <p>
    Tu inversión está protegida de la inflación argentina,
    pero la rentabilidad real considera la inflación
    estadounidense (pérdida de poder adquisitivo del dólar).
  </p>
