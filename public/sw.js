if (!self.define) {
  ...
  self.define = (a, n) => {
    const i = c || ('document' in self ? document.currentScript.src : '') || location.href;
    if (e[i]) return;
    let t = {};
    const r = (c) => s(c, i),
      l = { module: { uri: i }, exports: t, require: r };
    e[i] = Promise.all(a.map((c) => l[c] || r(c))).then((c) => (n(...c), t));
  };
}
  ...
  (importScripts(),
    ...
    c.precacheAndRoute(
      [
        ...
        { url: '/_next/static/chunks/1106-7a8d2e652e981450.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/1955-819c8e0dff2ec7bc.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/2312-abd2f78ec3c3b755.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/2462-5525360352daa555.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/2527-ae8f4be3fd43bbe5.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/2619-c01fe8612c164762.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/3418.d8b8cbd2f171ebd5.js', revision: 'd8b8cbd2f171ebd5' },
        { url: '/_next/static/chunks/3480-9473bdc5eba9ba20.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/3612-949f91f011d30826.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/4087-14f888950973e3f2.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/4135-4d3d19900dac8f06.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/4287-fea5eaba85423aba.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/436-6ba9717209f1058d.js', revision: 'lcIaGGk169J40mvkclncA' },
        {
          url: '/_next/static/chunks/4bd1b696-b7be8402c29a2bf8.js',
          revision: 'lcIaGGk169J40mvkclncA',
        },
        { url: '/_next/static/chunks/5929-422c5849b5708d26.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/6184.e28cbee9080ea4be.js', revision: 'e28cbee9080ea4be' },
        { url: '/_next/static/chunks/6770-edf57c9e9dcd6387.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/7255-69e5faf06858e5d7.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/7487-a4d50e887eb533f2.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/7587-5c262ca43f0b412e.js', revision: 'lcIaGGk169J40mvkclncA' },
        {
          url: '/_next/static/chunks/760c0163-47d4c11cf5e85808.js',
          revision: 'lcIaGGk169J40mvkclncA',
        },
        { url: '/_next/static/chunks/8287-9f350833b1fccd92.js', revision: 'lcIaGGk169J40mvkclncA' },
        { url: '/_next/static/chunks/8332-2e592d245df9b7b2.js', revision: 'lcIaGGk169J40mvkclncA' },
        {
          url: '/_next/static/chunks/94726e6d-502ba1ac5629ff07.js',
          revision: 'lcIaGGk169J40mvkclncA',
        },
        { url: '/_next/static/chunks/9981-775356befe74728e.js', revision: 'lcIaGGk169J40mvkclncA' },
        {
          url: '/_next/static/chunks/framework-1869d3a69b51e224.js',
          revision: 'lcIaGGk169J40mvkclncA',
        },
        { url: '/_next/static/chunks/main-a54eb0d23f8e06f1.js', revision: 'lcIaGGk169J40mvkclncA' },
        {
        ...
        {
          url: '/_next/static/chunks/pages/_app-3b861cde6f1cf451.js',
          revision: 'lcIaGGk169J40mvkclncA',
        },
        {
        ...
        { url: '/_next/static/css/912ebe11d97c1993.css', revision: '912ebe11d97c1993' },
        { url: '/_next/static/css/a9b21774882a3827.css', revision: 'a9b21774882a3827' },
        {
          url: '/_next/static/lcIaGGk169J40mvkclncA/_buildManifest.js',
          revision: '19fecba4124431af39b95252ff93e737',
        },
        {
          url: '/_next/static/lcIaGGk169J40mvkclncA/_ssgManifest.js',
    ...
    c.registerRoute(
      ...
      new c.NetworkFirst({
        ...
        plugins: [
          {
            cacheWillUpdate: async ({ request: c, response: e, event: s, state: a }) =>
    ...
    c.registerRoute(
      ...
      new c.NetworkFirst({
        ...
        plugins: [new c.ExpirationPlugin({ maxEntries: 32, maxAgeSeconds: 60 })],
      }),
      'GET'
    ),
    c.registerRoute(
      ...
      new c.NetworkFirst({
        ...
        networkTimeoutSeconds: 10,
        plugins: [new c.ExpirationPlugin({ maxEntries: 32, maxAgeSeconds: 300 })],
      }),
      'GET'
    ),
    c.registerRoute(
      ...
      new c.CacheFirst({
        ...
        plugins: [new c.ExpirationPlugin({ maxEntries: 64, maxAgeSeconds: 2592e3 })],
      }),
      'GET'
    ));
});
