    ...
    <Card variant="elevated" padding="lg">
      <div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="text-center p-3 rounded-lg bg-panel border border-border/5">
          ...
          {displayedStats.map((stat, index) => {
            ...
            return (
              <div
                ...
                className="p-3 rounded-lg bg-panel border border-border/5 hover:border-brand/30 transition-all"
              >
                {/* Bloque info */}
        ...
        {sortedStats.length > 8 && (
          <div className="mt-4 pt-4 border-t border-border/10">
            <button
              ...
              className="w-full px-3 py-2 rounded-lg bg-panel border border-border/5 text-foreground hover:bg-panel/10 hover:border-brand/50 transition-all text-sm"
            >
