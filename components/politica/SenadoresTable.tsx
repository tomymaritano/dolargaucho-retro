        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-dark-light border border-border/5 rounded-lg text-white placeholder-secondary focus:outline-none focus:border-brand/50 focus:ring-2 focus:ring-brand/20 transition-all"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2.5 bg-dark-light border border-border/5 rounded-lg text-white focus:outline-none focus:border-brand/50 focus:ring-2 focus:ring-brand/20 transition-all"
          >
        ...
        <div className="mt-4 pt-4 border-t border-border/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 bg-dark-light border border-border/5 rounded-lg text-white text-sm focus:outline-none focus:border-brand/50 focus:ring-2 focus:ring-brand/20 transition-all"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg border border-border/5 bg-dark-light text-white hover:bg-panel/10 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    ...
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg border transition-all ${
                        currentPage === pageNum
                          ...
                          : 'border-border/10 bg-dark-light text-white hover:bg-panel/10'
                      }`}
                    >
                      {pageNum}
                    </button>
