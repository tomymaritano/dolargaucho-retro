    ...
    <section className="relative w-full h-screen flex flex-col items-center justify-center text-foreground overflow-hidden bg-background">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          >
            <span className="text-xs text-secondary/60 group-hover:text-brand transition-colors uppercase tracking-wider">
              Scroll
            </span>
            <svg
              className="w-6 h-6 text-brand/60 group-hover:text-brand transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
