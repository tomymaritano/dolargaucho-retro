...
export const ElectionCard = React.memo(function ElectionCard({
  ...
  return (
    ...
    >
      {/* Glassmorphism Card */}
      <div className="relative p-6 md:p-8 rounded-2xl backdrop-blur-sm bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent border border-white/5 hover:border-white/20 transition-all duration-500">
        {/* Glow Effect */}
