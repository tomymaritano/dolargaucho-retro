...
export const ECBRateCard = React.memo(function ECBRateCard({
  ...
  return (
    <div
      className="group relative p-4 md:p-5 rounded-xl bg-panel/50 border border-border hover:border-brand/30 hover:bg-panel/80 transition-all duration-300 cursor-pointer overflow-hidden"
