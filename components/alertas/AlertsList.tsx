            ...
            <div className="space-y-3">
              ...
              <div className="text-xs">
                ...
                {!isDisparada && !isPausada && valorActual !== null && (
                  <div className="flex items-center justify-between p-2 rounded-lg bg-panel border border-border/5">
              ...
              {alerta.mensaje && (
                <div className="p-2.5 rounded-lg bg-panel/50 border border-border/5/50">
