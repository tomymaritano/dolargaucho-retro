...
export const DashboardPreview = React.memo(function DashboardPreview() {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-panel/50 border border-white/10 hover:border-brand/30 transition-all group aspect-video shadow-2xl shadow-brand/10">
