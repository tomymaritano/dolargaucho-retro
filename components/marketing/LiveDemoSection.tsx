  ...
  return (
    <section id="demo" className="relative w-full py-20 sm:py-28 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {/* Dashboard Preview */}
          <div className="relative rounded-2xl overflow-hidden bg-panel/50 border border-border/5 hover:border-brand/30 transition-all group aspect-video">
        ...
        >
          <motion.div
            className="text-center p-6 rounded-xl bg-panel border border-border/5 hover:border-brand/30 transition-all group"
            whileHover={{ y: -5 }}
