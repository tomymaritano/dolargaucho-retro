        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {dataSources.map((source, index) => {
            ...
            return (
              ...
              >
                <SpotlightCard
                  className="group bg-panel border border-border/5 rounded-xl p-6 hover:border-brand/30 hover:shadow-lg hover:shadow-brand/5 transition-all duration-300"
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="px-3 py-1 rounded-full text-xs font-bold bg-panel/10 text-secondary border border-border/5">
                      {source.badge}
                    </span>
                  </div>
