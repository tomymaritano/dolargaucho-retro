    ...
    <section className="relative w-full py-20 sm:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            <motion.div
              ...
              className="bg-panel border border-border rounded-2xl p-8 hover:border-error/30 transition-all"
            >
            ...
            >
              ...
              <div className="grid gap-3">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-panel/10 border border-border">
          ...
          >
            ...
            <motion.div
              whileHover={{ y: -4 }}
              transition={{ type: 'spring', stiffness: 300 }}
              className="bg-panel border border-border rounded-2xl p-8 hover:border-brand/20 transition-all"
            >
              <div className="flex items-start gap-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-panel/10 border border-border transition-all"
                  >
        ...
        <motion.div
          ...
          className="bg-panel border border-border rounded-2xl p-8"
        >
