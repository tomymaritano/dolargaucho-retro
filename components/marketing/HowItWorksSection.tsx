            ...
            >
              ...
              <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                ...
                >
                  {step.visual === 'signup' ? (
                    // Signup mockup
                    <div className="bg-gradient-to-br from-background via-background to-background-secondary rounded-2xl p-8 border border-border/5 shadow-2xl shadow-black/20">
                        ...
                        <div className="space-y-3">
                          {['Nombre completo', 'Email', 'Contraseña'].map((field, i) => (
                            <motion.div
                              ...
                              className="bg-panel border border-border/5 rounded-lg p-3"
                            >
                    ...
                    // Alerts mockup
                    <div className="bg-gradient-to-br from-background via-background to-background-secondary rounded-2xl p-6 border border-border/5 shadow-2xl shadow-black/20">
                      <div className="mb-4">
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <motion.div
                            ...
                            transition={{ delay: i * 0.1 }}
                            className="bg-panel border border-border/5 rounded-lg p-3 flex items-center justify-between"
                          >
                            <div>
