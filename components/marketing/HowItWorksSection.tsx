            ...
            >
              ...
              <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                ...
                >
                  {step.visual === 'signup' ? (
                    // Signup mockup
                    <div className="bg-gradient-to-br from-background via-background to-background-secondary rounded-2xl p-8 border border-white/5 shadow-2xl shadow-black/20">
                    ...
                    // Alerts mockup
                    <div className="bg-gradient-to-br from-background via-background to-background-secondary rounded-2xl p-6 border border-white/5 shadow-2xl shadow-black/20">
                      <div className="mb-4">
