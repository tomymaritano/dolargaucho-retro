...
import { EconomicChartsCarousel } from './EconomicChartsCarousel';
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                >
                  Datos económicos en{' '}
                  <GradientText className="font-black">tiempo real</GradientText>
                </motion.h2>
                ...
                >
                  Visualizá la evolución de riesgo país, inflación y más. Gráficos interactivos con
