  ...
  return (
    <Link href="/elecciones" className="block w-full">
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className="relative w-full flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl bg-panel/50 border border-border/5 hover:border-brand/30 hover:bg-panel/80 transition-all duration-300 group cursor-pointer overflow-visible"
      >
