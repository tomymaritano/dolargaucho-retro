...
export const NavbarSearch = React.memo(function NavbarSearch() {
  ...
  return (
    <>
      ...
      <button
        onClick={handleOpen}
        className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-lg bg-panel/10 border border-border/5 hover:border-brand/30 hover:bg-panel/20 text-secondary hover:text-foreground transition-all group"
      >
        <FaSearch className="text-xs group-hover:text-brand transition-colors" />
        <span className="text-xs">Buscar</span>
        <kbd className="hidden md:inline-block px-1.5 py-0.5 text-[10px] font-mono bg-panel/20 border border-border/5 rounded">
          ⌘K
        </kbd>
      </button>
          ...
          <>
            ...
            <div className="fixed inset-0 z-[70] flex items-start justify-center pt-[12vh] px-4">
              <motion.div
                ...
                className="w-full max-w-2xl bg-panel/95 backdrop-blur-xl border border-border/5 rounded-2xl shadow-2xl overflow-hidden"
              >
                {/* Header */}
                <div className="sticky top-0 bg-gradient-to-b from-panel to-panel/95 backdrop-blur-sm px-6 py-4 border-b border-border/10">
                ...
                {/* Footer hint */}
                <div className="sticky bottom-0 px-6 py-4 border-t border-border/10 bg-gradient-to-t from-panel to-panel/95 backdrop-blur-sm">
                  <div className="flex items-center justify-between text-xs font-medium">
                    <div className="flex items-center gap-4">
                      <span className="flex items-center gap-1.5 text-secondary">
                        <kbd className="px-2 py-1 bg-panel/20 border border-border/5 rounded-md font-mono text-foreground shadow-sm">
                          ↑
                        </kbd>
                        <kbd className="px-2 py-1 bg-panel/20 border border-border/5 rounded-md font-mono text-foreground shadow-sm">
                          ↓
