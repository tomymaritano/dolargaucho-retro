      ...
      <nav className="fixed top-12 left-0 right-0 z-[45] bg-background/95 backdrop-blur-xl border-b border-border/10">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <AnimatePresence>
                  {profileOpen && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      transition={{ duration: 0.2 }}
                      className="absolute right-0 top-full mt-2 w-56 bg-panel rounded-lg shadow-2xl overflow-hidden border border-border/5"
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 hover:bg-background-secondary transition-colors text-left border-t border-border/10"
                      >
          ...
          {breadcrumbs.length > 1 && (
            <div className="hidden md:block px-4 py-2 border-t border-border/10">
        ...
        {menuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 bottom-0 w-72 bg-panel/95 backdrop-blur-xl border-r border-border/10 shadow-2xl z-[70] overflow-y-auto"
            >
              ...
              <div className="sticky top-0 bg-gradient-to-b from-panel to-transparent p-6 pb-4">
                ...
                {/* User Info - Compact */}
                <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-background-secondary/30 border border-border/5">
