...
export const CalendarioMensual = React.memo(function CalendarioMensual({
  ...
  return (
    <Card variant="elevated" padding="lg">
            ...
            >
              ...
              {(dia.esFeriado || dia.tieneEvento) && !dia.esOtroMes && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-10 pointer-events-none">
                  <div className="glass-strong border border-border/5 rounded-lg p-2 text-xs whitespace-nowrap">
                    {dia.feriados.map((f) => (
      ...
      {/* Leyenda */}
      <div className="flex items-center justify-center gap-6 mt-6 pt-6 border-t border-border/10">
