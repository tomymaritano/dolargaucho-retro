...
const inputVariants = cva(
  'w-full rounded-lg font-medium transition-all outline-none disabled:opacity-40 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        default:
          'bg-panel/10 border border-border/5 text-foreground placeholder-secondary/60 focus:bg-white/[0.07] focus:border-white/20 hover:border-white/15',
        outlined:
          'bg-transparent border border-brand/30 text-foreground placeholder-secondary/60 focus:border-brand hover:border-brand/50',
        filled:
          'bg-panel border border-border/5 text-foreground placeholder-secondary/60 focus:border-white/20 hover:border-white/15',
        error:
