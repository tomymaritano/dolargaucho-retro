                  ...
                  className={`
                    ...
                    ${
                      isSelected
                        ...
                        : 'border-border/10 hover:border-brand/40 text-secondary hover:text-foreground hover:scale-[1.02] active:scale-95'
                    }
                  `}
                >
                  <Icon
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 bg-panel border border-border/5 rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-brand/50"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 bg-panel border border-border/5 rounded-lg text-foreground placeholder-secondary focus:outline-none focus:ring-2 focus:ring-brand/50"
          />
        </div>
      </div>
