...
function InflationProjectionChart({
  ...
  return (
    <Card
      variant="elevated"
      padding="lg"
      className="mt-6 border border-white/5 hover:border-brand/40 transition-all duration-300"
    >
...
const FinancialCalculator = React.memo(function FinancialCalculator() {
  ...
  return (
    <div className="mx-auto text-foreground p-6 md:p-10 rounded-2xl max-w-7xl">
      ...
      {/* Estado de carga */}
      {dolarLoading && (
        <Card variant="elevated" padding="md" className="border border-white/5 text-center">
      ...
      <Card
        variant="elevated"
        padding="md"
        className="border border-white/5 mb-4 hover:border-brand/40 transition-all duration-300"
      >
