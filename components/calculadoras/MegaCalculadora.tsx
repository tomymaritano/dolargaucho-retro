      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 text-xl font-mono font-bold bg-panel border border-border/5 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand/50 focus:outline-none transition-all text-foreground"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-panel border border-border/5 rounded-xl focus:ring-2 focus:ring-brand/20 focus:border-brand/50 focus:outline-none transition-all text-foreground"
          />
        </div>
