...
export const Footer = React.memo(function Footer() {
  ...
  return (
    <footer className="relative bg-panel mt-12 border-t border-border/10 overflow-hidden">
      ...
      <div className="relative mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.div
          ...
          className="pt-8 mb-8 border-t border-border/10"
        >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-secondary pt-6 border-t border-border/10">
