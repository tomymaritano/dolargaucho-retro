        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-dark-light border border-border/5 rounded-lg text-white placeholder-secondary focus:outline-none focus:border-brand/50 focus:ring-2 focus:ring-brand/20 transition-all"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 bg-dark-light border border-border/5 rounded-lg text-white focus:outline-none focus:border-brand/50 focus:ring-2 focus:ring-brand/20 transition-all"
          >
              ...
              {filteredFCI.length === 0 ? (
                ...
                filteredFCI.slice(0, 50).map((fci, index) => {
                  ...
                  return (
                    <tr
                      key={`${nombre}-${index}`}
                      className="border-b border-border/10 hover:bg-panel/10 transition-colors"
                    >
